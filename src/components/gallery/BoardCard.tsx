  ...
  return (
    <BoardContextMenu boardId={board.id} boardTitle={board.title}>
      <div
        ...
        className={`group relative aspect-[16/10] cursor-pointer select-none overflow-hidden rounded-lg bg-neutral-200 outline-none transition-shadow hover:shadow-md focus-visible:ring-2 focus-visible:ring-blue-500 ${
          isOver ? "ring-[3px] ring-blue-500" : ""
        }`}
      >
        {thumb ? (
          <img
            src={imgixThumb(thumb, 320, 200)}
            alt=""
            draggable={false}
        ...
        <span className="pointer-events-none absolute bottom-2.5 left-3 right-9 truncate text-sm font-semibold text-white drop-shadow-sm">
          {board.title}
        </span>
